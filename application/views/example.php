...
<body>
	<div>
		...
		<a href='<?php echo site_url('daftar_masuk/driverLocation')?>'>DriverLocation</a> |
		...
		<a href='<?php echo site_url('daftar_masuk/QR')?>'>QR Bus Generator</a> |
		<a href='<?php echo site_url('daftar_masuk/logout')?>'>Logout</a>
