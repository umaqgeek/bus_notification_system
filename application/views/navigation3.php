...
<head>
    ...
    <link href="<?php echo base_url('asset3/css/bootstrap.min.css'); ?>" rel="stylesheet">
    <link href="<?php echo base_url('asset3/css/font-awesome.min.css'); ?>" rel="stylesheet">
    <link href="<?php echo base_url('asset3/css/animate.min.css'); ?>" rel="stylesheet">
    <link href="<?php echo base_url('asset3/css/owl.carousel.css'); ?>" rel="stylesheet">
    <link href="<?php echo base_url('asset3/css/owl.transitions.css'); ?>" rel="stylesheet">
    <link href="<?php echo base_url('asset3/css/prettyPhoto.css'); ?>" rel="stylesheet">
    <link href="<?php echo base_url('asset3/css/main.css'); ?>" rel="stylesheet">
    <link href="<?php echo base_url('asset3/css/responsive.css'); ?>" rel="stylesheet">
    <!--[if lt IE 9]>
...
<body id="home" class="homepage">
  ...
  <nav id="nb2sb-nav" class="navbar navbar-default navbar-fixed-top" rple="banner">
            <div class="container">
                <div class="navbar-header">
                  <a class="navbar-brand" href="#"></a>
                  
                  <!-- icon/button -->
                  <button id="nb2sb-btn" type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
           ...
           <!--     <div id="nb2sb-content">
                  <ul class="nav navbar-nav nav-pills navbar-right">
                    <li class="scroll active"><a data-toggle="pill" href="#home">Home</a></li>
                    <li class="scroll"><a data-toggle="pill" class="close-sb" href="#about">DinarPal</a></li>
               ...
               <div id="nb2sb-content">
                   <ul class="nav navbar-nav nav-pills navbar-right">
                   <!-- <li class="scroll active"><a data-toggle="pill" href="#home">Home</a></li>
                    <li class="scroll"><a data-toggle="pill" class="close-sb" href="#features">Features</a></li>
                    <li><a data-toggle="pill" href="#services">Services</a></li>
                    <li><a data-toggle="pill" class="close-sb" href="#portfolio">Keep</a></li>-->
                        <li class="scroll active"><a href="#home">Home</a></li>
                        <li class="scroll"><a href="#features">Features</a></li>
                        <li class="scroll"><a href="#hatta">Services</a></li>
    ...
    <script src="<?php echo base_url('asset3/js/jquery.js'); ?>" rel="stylesheet"></script>
    <script src="<?php echo base_url('asset3/js/bootstrap.min.js'); ?>" rel="stylesheet"></script>
    <script src="http://maps.google.com/maps/api/js?sensor=true"></script>
    <script src="<?php echo base_url('asset3/js/owl.carousel.min.js'); ?>" rel="stylesheet">></script>
    <script src="<?php echo base_url('asset3/js/mousescroll.js'); ?>" rel="stylesheet">></script>
    <script src="<?php echo base_url('asset3/js/smoothscroll.js'); ?>" rel="stylesheet">></script>
    <script src="<?php echo base_url('asset3/js/jquery.prettyPhoto.js'); ?>" rel="stylesheet">></script>
    <script src="<?php echo base_url('asset3/js/jquery.isotope.min.js'); ?>" rel="stylesheet">></script>
    <script src="<?php echo base_url('asset3/js/jquery.inview.min.js'); ?>" rel="stylesheet">></script>
    <script src="<?php echo base_url('asset3/js/wow.min.js'); ?>" rel="stylesheet">></script>
    <script src="<?php echo base_url('asset3/js/main.js'); ?>" rel="stylesheet">></script>
    ...
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.2/jquery.min.js"></script>
        ...
        <!-- Nb2Sb - Navbar to Sidebar -->
         <script src="<?php echo base_url('asset3/js/jquery.nb2sb.js'); ?>"></script>
