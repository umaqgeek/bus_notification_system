...
<body>
    ...
    <script type="text/javascript" src="<?php echo base_url('asset/http://maps.google.com/maps/api/js?sensor=true'); ?>"></script>
    <script type="text/javascript" src="<?php echo base_url('asset/js/gmaps.js'); ?>"></script>
